...
<form method="post" action="{{ route('publicacion.store') }}" enctype="multipart/form-data"></form>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="float-right col-2 justify-content-end">
                            <a href="{{ route('publicaciones.create') }}" class="btn btn-outline-primary btn-sm float-right"  data-placement="left"><i class="bi bi-bag-plus"></i>  Agregar Publicación</a>
                        </div>
                    </div>
