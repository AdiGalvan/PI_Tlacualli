                    ...
                    <table class="min-w-full bg-white shadow-1xl rounded-lg overflow-hidden font-sans">
                        <thead class="bg-green-900 text-white ">
                                    <tr>
                                        ...
                                        <th class="px-6 py-3 text-left text-1xl">Fecha de Cancelación</th>
                                    </tr>
                                </thead>
                                ...
                                @foreach ($mis_ordenes_can as $m_orden)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 text-base font-semibold">{{ $m_orden->updated_at->format('Y-m-d') }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                    </table>
                                ...
                                <tbody class="divide-y divide-gray-500 shadow-md">
                                    ...
                                    <tr>
                                        ...
                                        @if ($ins->publicacion)
                                            ...
                                            <td class="px-6 py-4 text-base font-semibold">{{ $ins->updated_at->format('Y-m-d') }}</td>
                                        @else
                                ...
                                <tbody class="divide-y divide-gray-500 shadow-md">
                                    ...
                                    <tr>
                                        ...
                                        @if ($sol->servicio)
                                            ...
                                            <td class="px-6 py-4 text-base font-semibold">{{ $sol->updated_at->format('Y-m-d')}}</td>
                                        @else
