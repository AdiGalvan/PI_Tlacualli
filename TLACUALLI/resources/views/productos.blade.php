...
<div class="flex flex-wrap justify-center">
    ...
    <div class="w-full lg:w-10/12">
        <div class="flex flex-wrap mb-4 justify-end px-5 mt-3">
            ...
            @if ($usuario->roles->id == 8)
                <div class="float-right col-2 justify-content-end">
                    <a href="{{ route('mis_productos') }}" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800"><i class="bi bi-folder"></i> Mis productos</a>            
                </div>    
            @endif
            </div>
        </div>
