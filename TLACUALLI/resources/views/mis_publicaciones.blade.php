...
<div class="mt-5 flex justify-center">
    <div class="w-full lg:w-10/12">  
        <h2 class="mb-6 text-3xl text-center font-semibold font-sans text-dark uppercase dark:text-white w-full">Mis Publicaciones</h2>
            @auth
                Autenticado
                @endauth
                @guest
        ...
        <div class="flex justify-end space-x-4 px-5 mb-6">
            <button type="button" class="bg-gradient-to-r from-green-500 to-green-800 text-white font-sans font-bold px-4 py-2 rounded-md text-md" onclick="window.location.href='{{ url('/publicaciones') }}'">Regresar</button>
            @auth
